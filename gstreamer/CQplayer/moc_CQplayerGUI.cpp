...
**
** Created: Fri May 27 11:59:08 2011
...
int CQplayerGUI::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_openFileButton_clicked(); break;
        case 1: on_sliderVlm_sliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: on_sliderProgress_sliderReleased(); break;
        case 3: on_sliderProgress_sliderPressed(); break;
        case 4: on_sliderProgress_sliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: on_backwardButton_clicked(); break;
        case 6: on_forwardButton_clicked(); break;
        case 7: on_pauseButton_clicked(); break;
        case 8: on_stopButton_clicked(); break;
        case 9: on_playButton_clicked(); break;
        default: ;
        }
        _id -= 10;
    }
